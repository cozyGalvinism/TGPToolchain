...
namespace TGPToolchain.ViewModels
{
    public class EditRecipeViewModel : ViewModelBase
    {
        ...
        public ReactiveCommand<Unit, LDBRecipe?> EditRecipeCommand { get; }
        public EditRecipeViewModel()
        {
            _itemBrowseList = new ObservableCollection<LDBItem>();
            EditRecipeCommand = ReactiveCommand.Create(() =>
                {
